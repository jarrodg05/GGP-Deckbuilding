...
public class GameControllerApp {
	...
	private JComboBox<String> jGDLVersionComboBox = null;
	...
	private Component getJGDLVersion() {
		...
		if (jGDLVersionComboBox == null) {
			jGDLVersionComboBox = new JComboBox<String>(new String[]{"Regular GDL", "GDL-II"});
			...
			jFileChooser.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent event) {
					if(event.getActionCommand().equals(JFileChooser.APPROVE_SELECTION)){
						...
						gaRunner.setGame(jFileChooser.getSelectedFile());
						gaRunner.runGUI(); 
