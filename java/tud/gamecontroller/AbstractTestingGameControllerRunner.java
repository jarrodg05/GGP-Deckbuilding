...
public abstract class AbstractTestingGameControllerRunner<
	...
	public AbstractTestingGameControllerRunner(final ReasonerFactoryInterface<TermType, ReasonerStateInfoType> reasonerFactory) {
		super();
	...
	public void run() throws InterruptedException{
		...
		if (players == null){
			players = createPlayers(game, gameScrambler);
		}
